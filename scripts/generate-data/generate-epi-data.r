...
epi1 <- rTrajObs(SIR_deter, parameters, initState, 1:100)
epi1 <- epi1[1:38, ]
epi1 <- epi1[c("time", "obs")]

parameters <- c(R_0 = 2.5, D_inf = 2, RR = 0.1)
epi2 <- rTrajObs(SIR_reporting_deter, parameters, initState, 1:100)
epi2 <- epi1[1:26, ]
...
epi3 <- rTrajObs(SIR_deter, parameters, initState, 1:100)
epi3 <- epi3[1:44, ]
...
epi4 <- rTrajObs(SIR_reporting_deter, parameters, initState, 1:100)
