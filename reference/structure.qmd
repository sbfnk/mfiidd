...
The course has 14 sessions organised into three tiers.
...
**Synthesis** (1-1.5 hours) - after the stochastic track:

> **Choosing an inference approach** — the methods side by side, and which one your own problem needs
