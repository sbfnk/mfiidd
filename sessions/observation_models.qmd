...
Poisson against negative binomial. A Poisson likelihood behaves like L2 in that
one improbable day dominates the total; a negative binomial behaves more like L1.
Choosing a distance and choosing an observation model are the same decision about
how much a single surprising observation should count.
:::
