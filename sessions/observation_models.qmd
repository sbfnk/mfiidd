...
**Estimated time**: 2-2.5 hours | **Optional advanced session**
:::

::: {.callout-note}
## Do this session if...
- You want to understand *why* we use Poisson or Negative Binomial likelihoods (not just *how*)
- You're interested in Approximate Bayesian Computation (ABC) as an alternative to likelihood-based inference
- You want to think critically about the assumptions underlying statistical inference

**Prerequisites**: Complete the core sessions through Particle MCMC. This session is conceptual and doesn't build on specific code from earlier optional sessions.
:::
...
The following sessions cover advanced topics and are optional:
