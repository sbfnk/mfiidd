...
**Estimated time**: 2-2.5 hours | **Advanced session** | **Requires**: Particle MCMC
:::

# Introduction

> **Do this session if** you want to understand *why* we use Poisson or Negative Binomial likelihoods (not just how), or you're curious about ABC as an alternative to likelihood-based inference.
