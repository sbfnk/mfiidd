...
**Estimated time**: 2-2.5 hours | **Advanced session**
:::
...
**Prerequisites**: Complete the core sessions through Particle MCMC. This session is conceptual and doesn't build on specific code from other advanced sessions.
:::
