...
**Estimated time**: 2-2.5 hours (three different inference approaches)
:::
...
ABC rejection sampling is sensitive to the threshold choice. If the threshold is too strict, you'll wait a long time and get few (or zero) samples. If it's too loose, the approximate posterior will be close to the prior. We start with a relaxed threshold (300) here. If you want to experiment, try values between 200-500 and observe how the acceptance rate and posterior width change.
:::
