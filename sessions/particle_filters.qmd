...
**Estimated time**: 2-2.5 hours (particle filter calibration requires multiple runs)
:::
...
You've now completed the core inference workflow: defining models (Introduction), running MCMC (MCMC session), checking convergence (Diagnostics), and validating model fit (Model Checking). You've also seen the SEITL model structure. This session introduces particle filters - the key technique for fitting *stochastic* models where the same parameters can produce different trajectories.
:::
