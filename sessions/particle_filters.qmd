...
- **4-8 particles**: SD in the tens or worse, far too noisy for reliable inference
- **16-32 particles**: SD around 8, still well outside the target range
- **64 particles**: SD around 3, at the edge of the target range
- **128 particles**: SD below 1, the first count that is comfortably good enough
- **256-512 particles**: SD around 0.5, diminishing returns for the extra computation
