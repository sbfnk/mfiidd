...
# All observations - past in gray, current in red
scatter!(p, flu_tdc.time[1:5], flu_tdc.obs[1:5],
         label="Past observations", markersize=4, color=:gray)
scatter!(p, [flu_tdc.time[6]], [flu_tdc.obs[6]],
         label="Current observation", markersize=7, color=:red)
