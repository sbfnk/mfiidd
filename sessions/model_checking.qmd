...
function compute_summaries(trajectory)
    ...
    peak_time = argmax(trajectory)  # index i is day i, after the alignment above
...
tail, which is a stronger verdict than a mixed result would be.
...
at about 12 cases around day 14 and accounts for roughly 226 of the 312 reported
cases.
