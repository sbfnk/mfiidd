...
In the [SEITL session](seitl.qmd), we'll extend beyond the simple SIR model to explain the two-wave pattern in the Tristan da Cunha data using temporary immunity.
