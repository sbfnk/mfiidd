...
**Estimated time**: 2-2.5 hours (SBC section is computationally intensive)
:::
...
In the Introduction session, you learned to calculate priors, likelihoods, and posteriors manually. In the MCMC session, you implemented samplers and saw how Turing.jl automates inference. In the Diagnostics session, you learned to check whether the sampler has converged. Now we address a different question: even if the sampler worked, does your model make sense?
:::
