...
a little over 3 as the first wave takes off, falls to about 0.3 by day 15, and is then held close to 1
through days 20 to 30, which is what sustains the second wave.
Both of those moves are the network's doing rather than the structure's: the fall
is mostly the learned β collapsing, with depletion contributing about a third of
it, and the recovery is β climbing again while the susceptible fraction barely
