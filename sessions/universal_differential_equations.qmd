...
**Estimated time**: 2-3 hours | **Advanced session** | **Requires**: Comfort with ODE-based models (e.g. [model fitting in Julia](introduction.qmd)) and basic familiarity with neural networks (what layers and activation functions are)
:::
