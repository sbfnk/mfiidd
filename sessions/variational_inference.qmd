...
**Estimated time**: 1.5 hours | **Optional advanced session**
:::
...
**Prerequisites**: Complete the MCMC session. This session compares VI to MCMC, so you should understand how MCMC works first. No other optional sessions required.
:::
