...
::: {.callout-note title="Coming from Stan?"}
...
::: {.callout-tip}
## Workflow note
In your own work, you should run [prior and posterior predictive checks](model_checking.qmd) when fitting models. We skip these here to focus on comparing VI with MCMC.
:::
