...
The mean-field approximation forces this correlation to zero, which can lead to:
...
The full-rank approximation now captures the negative correlation between $R_0$ and $D_{\text{inf}}$, giving a much better approximation to the true posterior.
