...
Relaxing *that* assumption — learning the posterior as a function of the data, so that a new dataset costs nothing — is a bigger step, and the subject of the optional session on [neural posterior estimation](neural_posterior_estimation.qmd).
