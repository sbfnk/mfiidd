...
::::
:::: {.column width="40%"}
**Initialise** — draw $J$ particles from the initial state, each with weight $1/J$

::: {.fragment fragment-index=1}
**Propagate** — simulate each one forward to the next observation
:::

::: {.fragment fragment-index=2}
**Weight** — score it by how well it explains the observation,
$w_j = p(y_t \mid x_j, \theta)$, drawn here as size
:::

::: {.fragment fragment-index=3}
**Resample** — draw a new set in proportion to weight, so good particles are
copied and bad ones die
:::

::: {.fragment fragment-index=4}
**Repeat** to the end of the data. The average weight along the way estimates
$p(y \mid \theta)$.
:::
::::
:::::
