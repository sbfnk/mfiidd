...
## Handing it to a library {.smaller}

Having seen what Metropolis-Hastings does, you would not write it again. Use a
[probabilistic programming language]{.alert} instead.
...
`|` conditions the model on data; `sample()` then runs whichever algorithm you
name. The same model definition works with MH, RAM or NUTS.
