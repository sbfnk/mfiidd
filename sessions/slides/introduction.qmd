...
![](images/Big_picture_simplest.png)

##  {.center}

![](images/Big_picture_empty.png)

##  {.center}

![](images/Big_picture_empty_question.png)
...
## Interlude: probabilities {.smaller}
...
## Joint and marginal probabilities {.smaller}
...
- Example: the probability that Djokovic wins Wimbledon if it is sunny on the
  final day.
...
## Evaluating under the Poisson distribution
...
1. [**Evaluate the probability**]{.alert}
2. Randomly sample
:::
::::
...
:::
::: {.column width="45%"}
Give me a random sample from the distribution.
...
- E.g. the temperature in London tomorrow
...
## Evaluating under the normal distribution
...
:::
::: {.column width="45%"}
What is the probability density of $30^\circ$C tomorrow?
...
![](images/Big_picture_deterministic_models_with_observations_simple.png)

##  {.center}

![](images/Big_picture_deterministic_models_with_observations.png)
