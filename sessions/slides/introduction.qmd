...
## Why we cannot just try everything {.smaller}
...
# Appendix: held in reserve {visibility="uncounted"}
...
## Frequentist vs Bayesian inference {.smaller visibility="uncounted"}
...
## Model *inference*: model selection {visibility="uncounted"}
