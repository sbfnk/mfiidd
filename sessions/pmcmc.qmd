...
## Code explainer
- **`StateSpaceModel(...)`** - assembles the state-space model from initial distribution, dynamics, and observation components defined in `src/seit4l_particle_filter.jl`.
