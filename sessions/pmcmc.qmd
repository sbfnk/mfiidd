...
::: {.callout-tip}
## Workflow note
In your own work, you should run [prior and posterior predictive checks](model_checking.qmd) alongside particle MCMC. We skip these here to focus on the PMMH algorithm.
:::
