...
::: {.callout-tip}
## Workflow note
In your own work, you should run [prior and posterior predictive checks](model_checking.qmd) when fitting models. We skip these here to focus on the PMMH algorithm.
:::
...
::: {.callout-warning title="Exercise: Run your own short PMMH chain"}
...
::: {.callout-warning title="Exercise: Interpret the stochastic vs deterministic comparison"}
...
::: {.callout-warning title="Exercise: Posterior predictive comparison"}
