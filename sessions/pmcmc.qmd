...
One solution is *Robust Adaptive Metropolis (RAM)* which automatically learns the posterior covariance structure during sampling ([Vihola, 2012](https://doi.org/10.1007/s11222-011-9269-5)). But RAM needs many samples to learn the covariance - often requiring long chains.
