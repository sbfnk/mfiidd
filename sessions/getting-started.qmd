...
| Full day (8 hrs) | Getting Started → Introduction → MCMC → Diagnostics |
| Two days (16 hrs) | Core sessions + SEITL + Particle Filters |
| Three days (24+ hrs) | Core + Stochastic models + one advanced topic |
