...
This reads `Project.toml` and `Manifest.toml` to install all required packages with exact versions. The first run downloads and precompiles packages, which can take 10-20 minutes depending on your internet connection.

::: {.callout-note}
## Expect lots of output
Package installation produces many messages about downloading, building, and precompiling. This is normal. Warnings about "precompilation may be incomplete" are usually harmless.
:::
