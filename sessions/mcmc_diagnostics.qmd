...
::: {.callout-note collapse="true"}
## Watching inference live

The divergence check above runs once the fit has finished.
[Watching a fit unfold](../reference/live_monitoring.qmd) shows an optional dashboard for watching inference in progress and reviewing the results, worth reaching for when a model is slow enough that you want to catch problems before the run ends.
:::
