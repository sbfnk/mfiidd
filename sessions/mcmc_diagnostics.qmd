...
**Next session**: With reliable MCMC diagnostics in hand, you're ready to tackle more complex models. In [Modelling interlude: Tristan da Cunha & SEITL](seitl.qmd), we'll introduce a real dataset and more realistic epidemic models that we'll use throughout the rest of the course.
