...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, cache.path="cache/mcmc/", fig.retina=1 ,fig.path="figure/mcmc/", fig.cap='', fig.align="center", tiy = TRUE)
```
