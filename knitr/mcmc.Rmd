...
```{r}
my_logPosterior_R0(3)
```

We can now generate samples from `my_logPosterior_R0` using `my_mcmcMH`. Can you work out the command to do this? If have any problems with this, have a look at our [solution](generate_samples.md).
