...
1. The $R_0$ of influenza is commonly estimated to be around 2. However, it can be significantly larger ($R_0>10$) in close-knit communities with exceptional contact configurations.
...
If you didn't manage to get the two waves, you can have look at [our solution](play_with_seitl_example.md#parameter-values-and-initial-state).
