...
my_mcmcMH <- function(target, init.theta, covmat.proposal, n.iterations) {
    ...
    for (i.iteration in seq_len(n.iterations)) {
        ...
        # 'rnorm' returns an unnamed vector, but the functions of
        ...
        log.acceptance <- # INSERT HERE: compute Metropolis-Hastings ratio
...
If you run into any problems, have a look at our [solution](mcmc_example_solution.md). Otherwise you can [return](mcmc.md#the-metropolis-hastings-sampler) to the practical.
