...
You can now go back to the [practical](play_with_seitl.md#run-a-mcmc) and try to run MCMC with those settings.
...
```
The thinned trace shows a smoother distribution despite having less samples than the unthinned one. This because the local "bumps" of the unthinned distribution are causedby  autocorrelated samples.
