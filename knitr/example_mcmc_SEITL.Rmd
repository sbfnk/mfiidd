...
You can now go back to the [practical](mcmc_and_model_comparison.md#model-selection) for the final exercise of the session.
...
print(DIC)
```
Follow this [link](mcmc_and_model_comparison.md#model-selection) to go back to the practical.
