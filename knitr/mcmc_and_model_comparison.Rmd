...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, cache.path="cache/seitl_fit_deter/", fig.retina=2 ,fig.path="figure/seitl_fit_deter/", fig.cap='', fig.height=3, fig.width=5, dpi=100, fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
...
If you have trouble filling any of the empty bits, have a look at our [more guided example](our_ppc_insert.md).
...
Previous: [Modelling interlude](play_with_seitl.md) Next: Particle MCMC
</div>
