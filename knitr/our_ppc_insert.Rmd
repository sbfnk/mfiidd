...
If you run into any problems, have a look at our [solution](our_ppc.md), otherwise [return](mcmc_and_model_comparison.md#posterior-predictive-checks) to the pMCMC practical.
