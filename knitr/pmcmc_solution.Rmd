...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, cache.path="cache/pmcmc/", fig.retina=1 ,fig.path="figure/pmcmc/", fig.cap='', fig.height=10, fig.width=10, dpi=100, fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
...
You can now return to the [practical](pmcmc.md#setting-the-pmcmc) and set your pMCMC with 400 particles.
...
init.state <- c(S = 279, E = 0, I = 2, T1 = 3, T2 =0, L = 0, Inc = 0)
log.like.theta.bar <- -117.5994 # TODO: replace by my_particleFilter(SEIT2L_stoch,theta.bar, init.state, data=FluTdC1971, n.particles=400)
