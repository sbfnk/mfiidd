...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, cache.path="cache/smc/", fig.retina=1 ,fig.path="figure/smc/", fig.cap='', fig.height=3, fig.width=5, dpi=100, fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
