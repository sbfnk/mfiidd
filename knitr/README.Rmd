...
5. [Modelling interlude](play_with_seitl.md)
6. [MCMC and model comparison](mcmc_and_model_comparison.md)
7. [Particle filter and pMCMC](pmcmc.md)
8. [Approximate Bayesian Computation](ABC.md)
