...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, cache.path="cache/mcmc_diagnostics/", fig.retina=1 ,fig.path="figure/mcmc_diagnostics/", fig.cap='', fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
...
trace <- mcmcMH(target = my_logPosterior_exp_epi3,
