...
```{r setup, echo=FALSE}
opts_chunk$set(cache=T, cache.path="cache/mcmc_diagnostics/", fig.retina=1 ,fig.path="figure/mcmc_diagnostics/", fig.cap='', fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
