...
```{r setup, echo=FALSE}
opts_chunk$set(cache=FALSE, cache.path="cache/SEITL_model/", fig.retina=1 ,fig.path="figure/SEITL_model/", fig.cap='', fig.height=3, fig.width=5, dpi=100, fig.align="center", message=FALSE, tidy=TRUE)
```
