Below, you can find an example of how to code the posterior predcitive checks. Some bits are left out for you to fill in (marked "INSERT HERE"). Each "INSERT HERE" statement requires one line of code. If you struggle, you can find a link to a solution below the function.

```{r our_ppc, eval=FALSE}
