% Modelling of past and current Ebola outbreaks.

```{r setup, echo=FALSE, cache=FALSE}
opts_chunk$set(cache=TRUE, fig.path='figure/ebola_project/', cache.path='cache/ebola_project/' ,fig.cap='', fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
