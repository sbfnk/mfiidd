...
```{r load_sirExp, message = FALSE, results = "hide"}
data(sirExp)
```
...
my_dLogPosteriorExpEpi3 <- function(theta) {
	...
	return(my_dLogPosterior(fitmodel = sirExp,
		theta = theta,
...
trace <- my_mcmcMh(target = my_dLogPosteriorExpEpi3,
	initTheta = c(R0 = log(1), D_inf = log(2)),
...
trace <- mcmcMh(target = my_dLogPosteriorEpi3,
