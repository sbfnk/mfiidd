...
my_posteriorTdC <- function(theta){
	...
	return(logPosterior(fitmodel =  my_fitmodel, theta = theta, init.state =  my_init.state, data = FluTdC1971, margLogLike  =  dTrajObs, log = TRUE))
...
__By contrast, for a uni-modal posteriors, combining chains is an efficient way to increase the ESS and the precision of the posterior estimates.__ Furthermore, running several "shorter" chains in parallel is faster than running one "long" chain.
