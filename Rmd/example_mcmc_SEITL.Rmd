...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, cache.path="cache/example_mcmc_SEITL/", fig.retina=2 ,fig.path="figure/example_mcmc_SEITL/", fig.cap='', fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
