...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE,fig.path='figure/mcmc_and_model_comparison/', cache.path='cache/mcmc_and_model_comparison/' , fig.cap='', fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
...
Each chain took 5 hours on a scientific computing cluster (thanks [Bernard](figure/import/bernard-cazelles.jpg)) and can be loaded as follows:
