...
* If you initialise the MCMC with a `initTheta` far from the region of high posterior density, __the chain might take a long time to reach this region of interest__ and you will have to burn a lot of iterations.
...
# run the MCMC
my_mcmcTdC <- mcmcMh(target = my_posteriorTdC,
                      initTheta = initTheta,
...
my_postPredCheck(trace = mcmc_SEITL_theta1$trace[seitlDeter$thetaNames],
                 nSamples = 100,
                 fitmodel = seitlDeter,
                 initState = initState,
                 data = FluTdC1971)
