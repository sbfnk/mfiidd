...
You can now plug this into the `mcmcMH` (or `my_mcmcMH`, if you would like to use your own) function. Can you work out the command to run ABC-MCMC? If not, have a look at the [solution](abc_solution.md#abc-mcmc-on-the-stochastic-model).
...
If you have any trouble running the MCMC, have a look at our [solution](abc_solution.md#comparison-with-exact-posterior).
