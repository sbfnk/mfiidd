...
hist(replicate(100, ssSize(rTrajObs(seitlStoch, theta, initState, FluTdC1971$time))), xlab = "summary statistic")
```
...
computeDistanceAbc(sumStats = list(ssSize, ssMax),
...
```{r distances_plot}
hist(replicate(100, computeDistanceAbc(sumStats = list(ssSize, ssMax),
                                       distanceAbc = ssMeanRelDistance,
                                       fitmodel = seitlStoch,
                                       theta = theta,
                                       initState = initState,
...
```{r abclogpost, eval=F}
my_abcAlgorithm(N=1000, epsilon = 5,
...
pop_1<-my_abcAlgorithm(N=1000, epsilon = 10000,
                   sum.stats = list(ssMax, ssSize),
                   distanceAbc = ssMeanRelDistance,
                   fitmodel = seitlStoch,
                   initState = initState,
