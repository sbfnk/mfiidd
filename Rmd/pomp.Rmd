...
This matches the deterministic skeleton to the data by maximising the likelihood (i.e., it is a frequentist fitting method) using a standard optimisation method (see `?traj.match` for details on the methods available.
...
```{r}
SEITL.mf <- mif(SEITL.tm, Nmif = 50, Np = 1000, cooling.fraction = 0.8, rw.sd = prop.sd)
