...
__Take 15 minutes__ to have a look at the code that is printed when you execute this command, and try to understand what it does. You can have a look at our [more detailed explanation](pomp_seitl_explanation.html) for further help. How would you change this to get the `SEIT4L` model? You can have a go at it yourself, or load our version using
