...
pop_1<-my_abcAlgorithm(N=1000, epsilon = 50,
  ...
  while(i < N){
    ...
    theta <- c(R0 = 2, D_lat = parsPerturb[["D_lat"]], D_inf = parsPerturb[["D_inf"]], alpha = 0.9, D_imm = 13, rho = 0.85)
    ...
    # and data
    dist <- computeDistanceAbc(sumStats = list(ssMax, ssSize),
                             distanceAbc = ssMeanRelDistance,
                             fitmodel = seitlStoch,
                             theta = theta,
                             initState = initState,
