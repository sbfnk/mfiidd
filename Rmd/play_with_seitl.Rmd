...
set.seed(1234)
```
[Lecture slides](slides/sto_2018.pdf)
...
A brief technical note: You might be confused that we use a function called `data` to load a `fitmodel`. However, this was the best way to provide you with models that preserved comments in the code of the function. Type `SEITL_deter$simulate`, for instance.
