...
initState.bad.guess <- c("S" = 250, "E" = 0, "I" = 4, "T" = 0, "L" = 30, "Inc" = 0)
plotFit(seitlDeter, theta.bad.guess, initState.bad.guess, data = FluTdC1971)
```
...
plotFit(seitlDeter, theta.bad.guess, initState.bad.guess, data = FluTdC1971, all.vars = TRUE)
```
...
plotFit(seitlDeter, theta.bad.guess, initState.bad.guess, data = FluTdC1971, n.replicates = 100)
```
...
plotFit(seitlDeter, theta.bad.guess, initState.bad.guess, data = FluTdC1971, n.replicates = 100, summary = FALSE)
```
...
p <- ggplot(data = df_plot, aes(x = x, y = value, group = k)) +
