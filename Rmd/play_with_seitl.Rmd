...
plotFit(seitlDeter, thetaBadGuess, initStateBadGuess, data = fluTdc1971, all.vars = TRUE)
```
...
plotFit(seitlDeter, thetaBadGuess, initStateBadGuess, data = fluTdc1971, n.replicates = 100)
```
...
plotFit(seitlDeter, thetaBadGuess, initStateBadGuess, data = fluTdc1971, n.replicates = 100, summary = FALSE)
```
