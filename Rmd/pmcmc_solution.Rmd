...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, fig.path='figure/pmcmc_solution/', cache.path='cache/pmcmc_solution/' , fig.cap='', fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
...
You've already finished? why not [going further?](pmcmc.html#going-further)
