...
traceThinN128 <- burnAndThin(trace, thin = 20)

# Let's plot the posterior densities
densityplot(x = traceThinN128)
```
...
plotPosteriorDensity(list(n16 = traceThinN16, n128 = traceThinN128))
```
...
plotPosteriorDensity(list(deter = traceDeter, sto = traceThinN128))
```
...
library("plyr")
traceCombined <- ldply(traceThinN128)
