...
You can visually inspect the fit of, for example, the SEIT4L model by plotting filtered trajectories as generated by the pMCMC algorithm

```{r}
p <- plot(bi[[4]], type="obs")
```

and you can get a summary of the parameter estimates using
