...
```{r}
seitlDet <- bi_model(lines = readLines("https://sbfnk.github.io/mfiidd/bi/SEITL_det.bi"))
```
...
<!--     R_0 ~ truncated_gaussian(mean = R_0, std = 3, lower = 1, upper = 50) -->
...
```{r}
seitlSto <- bi_model(lines = readLines("https://sbfnk.github.io/mfiidd/bi/SEITL_sto.bi"))
```
