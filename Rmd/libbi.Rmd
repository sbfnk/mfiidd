...
```r
SEITL_deter <- bi_model(lines=readLines("https://sbfnk.github.io/mfiidd/bi/SEITL_det.bi"))
```
...
You can visually inspect the fit by plotting filtered trajectories as generated by the pMCMC algorithm.

```r
p <- plot(bi[[4]], type="obs")
```
