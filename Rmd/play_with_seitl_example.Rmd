...
theta.guess1 <- c("R0"=4, "D_lat"=2 , "D_inf"=2, "alpha"=0.7, "D_imm"=13, "rho"=0.7)
...
theta.guess2 <- c("R0"=10, "D_lat"=2 , "D_inf"=2, "alpha"=0.7, "D_imm"=13, "rho"=0.7)
...
plotFit(SEITL_stoch,theta.guess3,init.state.guess,data=FluTdC1971, n.replicates=100, non.extinct=c("E", "I"))
```
...
```{r guess-3-stoch-SEIT4L, results="hide", fig.width=10}
init.state.guess.SEIT4L <- c("S"=279,"E"=0,"I"=2,"T1"=3, "T2"=0 , "T3"=0 ,"T4"=0 , "L"=0,"Inc"=0)
plotFit(SEIT4L_stoch,theta.guess3,init.state.guess.SEIT4L,data=FluTdC1971, n.replicates=100, non.extinct=c("E", "I"))
```
