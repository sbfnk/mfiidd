...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, fig.path='figure/play_with_seitl_example/', cache.path='cache/play_with_seitl_example/' , fig.cap='', fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
