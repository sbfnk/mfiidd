...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, fig.path='figure/introduction/', cache.path='cache/introduction/' ,fig.cap='', fig.align="center", message=FALSE, tidy=TRUE, warning=FALSE)
```
