...
```{r setup, echo=FALSE}
opts_chunk$set(cache=TRUE, fig.path='figure/mcmc/', cache.path='cache/mcmc/' , fig.cap='', fig.align="center")
```
...
We can now generate samples from `my_logPosterior_epi1` using `my_mcmcMH`. Can you work out the command to do this? If you have any problems with this, have a look at our [solution](generate_samples.html).
